...
describe("image validation", () => {
  ...
  it("should detect the file type of an Array<number> as a APNG file", () => {
    const file: Array<number> = [
      ...
      0x08, 0x61, 0x63, 0x54, 0x4c, 0x00, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00,
      0x00, 0xb1, 0x5e, 0x0f, 0xdb, 0x00, 0x00, 0x00, 0x1a, 0x66, 0x63, 0x54,
      0x4c, 0x00, 0x00, 0x00,
    ];

    const detectedFile = fileTypeChecker.isAPNG(file);
    expect(detectedFile).toBeTruthy();
  });
});
